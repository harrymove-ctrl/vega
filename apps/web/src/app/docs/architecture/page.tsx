...
export default function ArchitecturePage() {
    const architectureDiagram = `                                    +-----------------------+
                   ...
                   +---------------------+             +----------+----------+
                         ...
                         |                |               |               |                     |
              +----------v---+   +--------v------+  +-----v------+  +----v--------+   +--------v-------+
              | Supabase     |   | SoDEX REST |  | SoDEX   |  | TrollLLM /  |   | Telegram Bot   |
    ...
    return (
        <DocsPageLayout
            ...
            description="High-level systemic overview of Vega monorepo and service layer."
        >
            ...
            <p>Vega runs five background workers that handle asynchronous processing using a lease-based coordination system:</p>

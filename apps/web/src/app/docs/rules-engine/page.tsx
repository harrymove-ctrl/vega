...
export default function RulesEnginePage() {
    return (
        <DocsPageLayout
            title="Rules Engine"
            description="The decision-making core of Vega."
        >
            <DocsCallout title="Core Execution System">
                The rules engine evaluates bot strategy graphs against live market data and produces a list of actions to execute. It's the core system that takes user intent and translates it into on-chain SoDEX orders.
            </DocsCallout>

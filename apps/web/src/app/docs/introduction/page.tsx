...
export default function IntroductionPage() {
    return (
        <DocsPageLayout
            title="Introduction to Vega"
            description="Autonomous Trading Bot Platform Built on SoDEX Spot orderbook Infrastructure"
        >
            <DocsCallout title="What is Vega?">
                Vega reimagines the spot orderbook trading experience by shifting the user's role from manual trader to bot operator. The platform is designed around a single insight: most retail traders lose money placing discretionary trades, but systematic, rule-based strategies with proper risk controls can outperform emotional decision-making.
            </DocsCallout>

            <h2>How it works</h2>
            <p className="mb-8">
                Vega makes bot-driven trading accessible to everyone, from beginners who use pre-built templates to advanced quants who design sophisticated multi-condition strategies. The product flow is straightforward:
            </p>
            ...
            <div className="mb-12 border-l border-white/5 ml-2">
                ...
                <DocsStep number={2} title="Authorize delegated execution">
                    Allow Vega to place trades on your behalf through SoDEX's agent wallet system, without ever taking custody of your funds.
                </DocsStep>
                ...
                <DocsStep number={5} title="Deploy the bot">
                    Begin automated trading on SoDEX's spot orderbook markets.
                </DocsStep>
            ...
            <DocsCallout type="warning" title="Non-custodial by Design">
                Vega is not a custodial service. Users retain full control of their wallets at all times. The delegated authorization model ensures that Vega can only execute trades within the boundaries set by the user, and authorization can be revoked instantly.
            </DocsCallout>
        </DocsPageLayout>
    );
}

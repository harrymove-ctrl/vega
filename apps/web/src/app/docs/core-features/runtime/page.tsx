...
export default function RuntimePage() {
    return (
        ...
        >
            ...
            <p>
                The <code>BotRuntimeWorker</code> continuously polls for active runtimes, evaluates their rule sets against current market conditions, and submits actions to SoDEX when conditions are met.
            </p>

            <div className="my-6 space-y-3 pl-4 border-l border-white/10">
                <p className="not-prose text-sm text-neutral-400">Each evaluation cycle fetches real-time price data, candlestick history, and current position state from SoDEX's REST and WebSocket APIs.</p>

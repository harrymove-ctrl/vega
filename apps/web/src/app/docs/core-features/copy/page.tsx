    ...
    return (
        ...
        >
            <DocsCallout title="Accessing Community Alpha">
                Vega supports two distinct copy trading models: Live Mirroring and Configuration Cloning. Both models empower users to utilize community alpha while retaining capital custody.
            </DocsCallout>
